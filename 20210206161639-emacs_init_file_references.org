...
(custom-set-variables
 ...
 '(auto-save-file-name-transforms (quote ((".*" "~/.emacs-temp/\\1" t))))
 '(backup-directory-alist (quote ((".*" . "~/.emacs-temp/"))))
 ...
 '(package-selected-packages
   (quote
    (htmlize lister quelpa-use-package quelpa olivetti-mode dumb-jump livescript-mode olivetti counsel helm-swoop ivy-avy ivy org-roam-server pocket-reader consult consult-ripgrep org-roam helm-ls-git helm-rg helm-cmd-t volatile-highlights org-variable-pitch evil-lion evil-snipe evil-avy avy ewal-spacemacs-themes spacemacs-theme org-superstar evil-surround org-rich-yank evil-indent-plus delight moe-theme helm lua-mode markdown-mode emmet-mode rainbow-mode web-mode auctex coffee-mode js2-mode magit company ace-jump-mode evil use-package)))
 '(safe-local-variable-values (quote ((eval progn (hs-minor-mode) (evil-close-folds)))))
...
same directory as the org-buffer and insert a link to this file."
  ...
  (defun org-babel-execute:sh (body params)
    "Insert the current babel block into the fish command line, ready to run"
    (let ((b64-body (base64-encode-string (string-trim body) t)))
      (call-process "osascript" nil nil nil "-e"
                    (format "tell application \"iTerm\" to tell current session of current window to write text \" commandline (stty -echo; head -n1|base64 -d)\n%s\n\"" b64-body))
      ;;(call-process "osascript" nil nil nil "-e"
      ;;              (format "tell application \"iTerm\" to tell current session of current window to write text \"%s\\nhi\"" b64-body))
      (call-process "osascript" nil nil nil "-e"
  ...
  (defun org-yank-iterm-history-to-src-block ()
    "Insert the last-typed command from iTerm into the current org block, surrounding it with #+begin_src shell blocks. This makes it easy to edit the command in babel."
    (interactive)
    (call-process "osascript" nil nil nil "-e"
                  "tell application \"iTerm\" to tell current session of current window to write text \" echo -en '\\\\x1b]1337;Copy=:'(echo \\\\#cd $PWD\\\\n$history[1]|base64 -w0)'\\\\x07'\"")
    (message "Got stuff")
    (set-mark (point))
    (sleep-for 0.5)
    (yank)
...
(use-package org-roam
      ...
      :custom
      (org-roam-directory "/Users/kwilber/notes/days/")
      :bind (:map org-roam-mode-map
              ...
              (("C-c p" . org-yank-iterm-history-to-src-block))
              )
      :config
...
(add-to-list 'load-path "/Users/kwilber/.emacs.d/vendor/lister-20201223.125")
(add-to-list 'load-path "/Users/kwilber/.emacs.d/vendor/delve-20201225.1319")
(require 'lister)
(require 'delve)
#+end_src
